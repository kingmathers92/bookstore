...
export default function BookOfTheDay() {
  ...
  const formattedPrice = bookOfTheDayPrice.replace("{price}", "75 ر.س");
          ...
          <CardHeader className="p-0">
            <div className="relative">
              <img
                ...
                alt={t.bookOfTheDay || "Book of the Day"}
              ...
              />
              <div className="absolute inset-0 border-4 border-primary/50 rounded-t-lg animate-pulse-slow" />
            </div>
          </CardHeader>
