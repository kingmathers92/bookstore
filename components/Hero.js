...
export default function Hero() {
  ...
  return (
    <section
      className="relative min-h-screen sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px] lg:max-h-[600px] bg-fit bg-center"
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-t from-teal-800/50 via-transparent to-gold-300/50 flex items-center justify-center pt-20 sm:pt-16 md:pt-20 lg:pt-24">
        ...
        >
          <Card className="bg-cream-100/80 backdrop-blur-sm mb-40">
